package com.jasonpercus.microbean.cucumber.jdt.nominal.service.conditioned;
...
import com.jasonpercus.microbean.cucumber.jdt.nominal.service.AbstractService;

@Service
@Condition(value = PairCondition.class, negate = true)
public class ServiceConditionedNoKept extends AbstractService implements ServiceConditionedNoKeptAPI {
    ...
    public ServiceConditionedNoKept(Object1 object1,
                                    Object3 object3,
