...
@Configuration
public class P_ConfigurationWithBeanConditionValid {

    @Bean
    @Condition(P_ConditionAlwaysTrue.class)
    @SuppressWarnings("unused")
    public P_BeanConditionMethod beanConditionMethod() {
        return new P_BeanConditionMethod();
    }
}
